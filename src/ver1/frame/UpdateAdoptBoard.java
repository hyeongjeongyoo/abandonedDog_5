...
public class UpdateAdoptBoard extends JFrame {
	...
	public UpdateAdoptBoard(BoardFrame mContext, String title, String content, int id) {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (title.isEmpty() || content.isEmpty()) {
					...
					if(!content.equals(contentArea.getText())) {
						MyPageDAO.updateMyWrite(Define.UPDATE_MY_WRITE_CONTENT, contentArea.getText(), mContext.name, id);
					}
	...
	public static void main(String[] args) {
		new UpdateAdoptBoard(null, null, null,0);
	}
}